...
public abstract class Hilt_GamesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GamesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GamesFragment_GeneratedInjector) this.generatedComponent()).injectGamesFragment(UnsafeCasts.<GamesFragment>unsafeCast(this));
    }
  }
