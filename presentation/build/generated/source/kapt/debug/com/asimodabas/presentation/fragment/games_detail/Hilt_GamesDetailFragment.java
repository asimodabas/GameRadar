...
public abstract class Hilt_GamesDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GamesDetailFragment() {
    super();
  }

  Hilt_GamesDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GamesDetailFragment_GeneratedInjector) this.generatedComponent()).injectGamesDetailFragment(UnsafeCasts.<GamesDetailFragment>unsafeCast(this));
    }
  }
